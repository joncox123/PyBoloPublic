...
What features do you plan to implement next?
...
In the above PyBoloConfig.json file, you can change the "KEY_MAP" settings to the following possible keys:
